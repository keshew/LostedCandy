    ...
    var body: some View {
        GeometryReader { geometry in
            if verticalSizeClass == .regular {
                ...
                ZStack {
                    Image(candyStageModel.contact.imageBackgroundH[candyStageModel.currentIndex])
                        .resizable()
                        .ignoresSafeArea()
        ...
        .navigationDestination(isPresented: $candyStageModel.isGameAvailible) {
            if candyStageModel.currentIndex == 0 {
                StrawLoadingView()
            } else if candyStageModel.currentIndex == 1 {
                StarLoadingView()
            } else if candyStageModel.currentIndex == 2 {
                BouncingLoadingView()
            } else if candyStageModel.currentIndex == 3 {
                BoomLoadingView()
            }
        }
